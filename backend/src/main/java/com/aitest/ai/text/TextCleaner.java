...
// Source and modifications: docs/third-party-reuse.md; license: licenses/MeterSphere-LICENSE.
...
public class TextCleaner {
    ...
    public static String cleanMdTitle(String content) {
        ...
        return normalizeDocument(content).lines().map(TextCleaner::formMdTitle).collect(Collectors.joining("\n"));
    }

    /** Lossless normalization for requirements, SQL, JSON and runtime variables. */
    public static String normalizeDocument(String content) {
