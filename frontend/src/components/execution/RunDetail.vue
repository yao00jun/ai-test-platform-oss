...
.run-heading code { overflow-wrap: anywhere; }.run-counts { display: flex; flex-wrap: wrap; gap: 12px; margin-block: 20px; }.run-counts > div { flex: 1; min-width: 75px; padding: 14px 18px; background: var(--surface-muted); border-radius: 8px; }.run-counts span { display: block; color: var(--muted); font-size: 12px; }.run-counts strong { display: block; font-size: 24px; margin-top: 6px; }
.run-job { display: grid; gap: 10px; margin-bottom: 18px; }.run-download { display: flex; flex-wrap: wrap; align-items: flex-end; gap: 12px; margin-block: 18px; }.run-download label { display: grid; gap: 6px; font-size: 12px; }select { padding: 7px 12px; background: var(--surface); border: 1px solid var(--border); border-radius: 6px; color: var(--text); }
.run-item { border-block-start: 1px solid var(--border); padding: 22px 0; }.run-item header { margin-bottom: 16px; }.run-item-error { color: var(--danger); overflow-wrap: anywhere; white-space: pre-wrap; }.run-snapshot { margin: 24px 0; }.run-diagnoses { margin-block: 18px; }.json-view { max-height: 480px; overflow: auto; }summary { cursor: pointer; }
</style>
