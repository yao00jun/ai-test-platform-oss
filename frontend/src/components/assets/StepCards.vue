...
<style scoped>
.step-cards { padding: 16px; display: grid; gap: 16px; background: var(--color-fill-1); border-radius: 10px; }.step-card { padding: 16px; background: var(--color-bg-2); border: 1px solid var(--border); border-radius: 9px; min-width: 0; }.step-card.dragging { opacity: .5; }.step-heading { display: flex; gap: 8px; align-items: center; flex-wrap: wrap; }.step-heading :deep(.asset-name) { flex: 1; min-width: 100px; }.step-number { display: grid; place-items: center; width: 25px; height: 25px; border-radius: 50%; background: var(--primary-soft); color: var(--primary); font-size: 12px; }.functional-step-body { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; font-size: 13px; margin: 14px 0; }.functional-step-body > div { min-width: 0; }.functional-step-body h5 { margin: 0 0 6px; color: var(--muted); font-size: 12px; }.step-fields { display: grid; grid-template-columns: 95px minmax(0, 1fr); gap: 8px 12px; margin: 15px 0; font-size: 12px; }.step-fields dt { color: var(--muted); }.step-fields dd { margin: 0; white-space: pre-wrap; overflow-wrap: anywhere; font-family: var(--font-mono, monospace); }.step-sql { padding: 12px; background: var(--surface-code); border-radius: 6px; font-size: 12px; overflow: auto; max-height: 250px; }.step-actions { display: flex; justify-content: space-between; align-items: center; gap: 12px; margin-top: 14px; flex-wrap: wrap; }
