...
label { display: grid; gap: 8px; font-size: 13px; }input:not([type=file]), textarea, select { box-sizing: border-box; width: 100%; padding: 9px 12px; background: white; color: var(--text); border: 1px solid #cbd1df; border-radius: 6px; font: inherit; }textarea { resize: vertical; line-height: 1.7; }input:disabled, textarea:disabled, select:disabled { background: #f7f8fa; }.pipeline-file { padding: 24px; border: 1px dashed #b7bdd3; border-radius: 8px; background: #fafbff; }
.pipeline-options { margin-block: 24px; }.pipeline-options summary { cursor: pointer; font-weight: 600; padding-bottom: 18px; }.pipeline-wizard-actions { display: flex; justify-content: flex-end; flex-wrap: wrap; gap: 12px; margin-block: 20px; }.preview-issues { color: #b22f45; font-size: 13px; padding-left: 18px; }
</style>
