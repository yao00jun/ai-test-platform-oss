...
<style scoped>
.schedule-panel { min-width: 0; overflow-wrap: anywhere; }.schedule-heading { display: flex; gap: 12px; align-items: start; justify-content: space-between; }h3 { font-size: 15px; margin: 0 0 12px; }.schedule-form { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 14px; padding: 18px; background: var(--surface-subtle); border: 1px solid var(--border); border-radius: 8px; margin-block: 14px; }.schedule-form label { display: grid; gap: 7px; font-size: 12px; }.schedule-form input:not([type=checkbox]), .schedule-form select { box-sizing: border-box; width: 100%; min-width: 0; padding: 9px; color: var(--text); background: var(--surface); border: 1px solid var(--border); border-radius: 5px; font: inherit; }.schedule-form .schedule-enabled { grid-column: 1 / -1; display: flex; gap: 8px; align-items: center; }.schedule-help, .schedule-actions { grid-column: 1 / -1; }.schedule-actions { flex-wrap: wrap; }.schedule-success { color: var(--success); }.schedule-preview { border-left: 3px solid var(--primary); padding-left: 14px; font-size: 12px; margin-block: 20px; }.schedule-preview ol { padding-left: 18px; line-height: 2; }.schedule-summary { display: flex; flex-wrap: wrap; gap: 14px; font-size: 12px; margin-block: 20px 10px; }.schedule-occurrence { border: 1px solid var(--border); border-radius: 7px; padding: 14px; margin-block: 12px; font-size: 12px; }.schedule-occurrence header, .schedule-record-footer { display: flex; align-items: center; flex-wrap: wrap; justify-content: space-between; gap: 10px; }.schedule-conflict { border-left: 3px solid var(--warning-border); padding: 12px; font-size: 12px; margin-block: 12px; }@media (max-width: 560px) { .schedule-form { grid-template-columns: minmax(0, 1fr); }.schedule-heading { flex-wrap: wrap; } }
</style>
