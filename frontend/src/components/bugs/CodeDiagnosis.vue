...
<style scoped>
.code-diagnosis { min-width: 0; overflow-wrap: anywhere; }.rca-heading, .patch-preview header, .evaluation-record header { display: flex; align-items: start; justify-content: space-between; gap: 12px; flex-wrap: wrap; }h3 { font-size: 15px; margin: 0 0 10px; }h4 { font-size: 13px; margin: 0; }.rca-evidence { margin-block: 18px; }summary { cursor: pointer; font-size: 12px; }.rca-form { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 14px; padding: 16px; border: 1px solid var(--border); border-radius: 8px; margin-block: 16px; background: #f8f9fd; }.rca-form label { display: grid; gap: 7px; font-size: 12px; }.rca-form input, .rca-form textarea, .rca-form select { box-sizing: border-box; width: 100%; min-width: 0; padding: 9px; border: 1px solid var(--border); border-radius: 5px; background: white; color: var(--text); font: inherit; }.rca-form textarea { resize: vertical; line-height: 1.7; }.rca-form .patch-input, .patch-text { font: 12px/1.8 ui-monospace, Consolas, monospace; }.wide { grid-column: 1 / -1; }.rca-actions { flex-wrap: wrap; }.success { color: #16815d; }.rca-conflict { border-left: 3px solid #d78b27; padding: 12px; margin-block: 12px; font-size: 12px; }.patch-preview, .human-evaluation { margin-top: 24px; }.patch-text { padding: 14px; background: #f5f7fb; border: 1px solid var(--border); border-radius: 8px; white-space: pre; max-height: 420px; overflow: auto; }.evaluation-record { border-top: 1px solid var(--border); margin-top: 14px; padding-top: 14px; font-size: 12px; }.evaluation-record p { white-space: pre-wrap; }.evaluation-record details code { display: block; margin-top: 10px; word-break: break-all; }@media (max-width: 560px) { .rca-form { grid-template-columns: minmax(0, 1fr); padding: 12px; } }
</style>
