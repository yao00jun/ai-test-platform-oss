...
<style scoped>
.generation-evidence { min-width: 0; margin-bottom: 22px; padding: 16px; border: 1px solid var(--info-border); border-radius: 8px; background: var(--info-soft); overflow-wrap: anywhere; }header { display: flex; justify-content: space-between; gap: 12px; }h3 { font-size: 14px; margin: 0; }p { line-height: 1.7; margin: 10px 0 0; }.evidence-warning { color: var(--warning); font-size: 12px; }.locator-evidence { list-style: none; padding: 0; margin: 12px 0 0; display: grid; gap: 10px; }.locator-evidence li { display: grid; gap: 5px; padding-top: 10px; border-top: 1px solid var(--border); }button { text-align: left; color: var(--primary); font: inherit; font-size: 12px; background: none; border: 0; padding: 0; cursor: pointer; overflow-wrap: anywhere; }.evidence-excerpt { margin-top: 14px; font-size: 12px; }pre { max-height: 250px; overflow: auto; padding: 12px; background: var(--surface-muted); white-space: pre-wrap; line-height: 1.7; }
</style>
